...
export const metadata: Metadata = {
  title: 'About — Dokly',
  description: 'About Dokly — free online tools for PDF, image, and text processing.',
}

export default function AboutPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-2xl font-bold text-text mb-6">About Dokly</h1>
      <div className="space-y-4 text-sm text-muted leading-relaxed">
        <p>
          Dokly is a suite of free online tools for working with PDFs, images, and text.
        ...
        <p>
          Everything on Dokly runs entirely in your browser — no uploads, no servers, no waiting.
