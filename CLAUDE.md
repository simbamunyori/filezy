...
**Name:** Dokly
**Domain:** dokly.io *(register this first — check availability on Namecheap)*
...
**Dokly wins on three things competitors cannot easily copy:**
...
- H2: "Why use Dokly to merge PDFs?" with 3 bullet points
...
User-agent: *
Allow: /
Sitemap: https://dokly.io/sitemap.xml
```
...
```
[Dokly logo]     PDF Tools  Image Tools  Text Tools  All Tools     [Search]
```

- Logo: "Dokly" in Geist Bold, electric blue dot after the "y"
...
[FOOTER]
  Dokly — Free online tools for everyone
...
- `/alternatives/smallpdf` — "Dokly vs Smallpdf: Same tools, no limits, no paywall"
- `/alternatives/ilovepdf` — "Dokly vs iLovePDF: Unlimited free, no file size cap"
- `/alternatives/tinywow` — "Dokly vs TinyWow: No CAPTCHAs, clean interface"
